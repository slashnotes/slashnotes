...
export function AddMode({
  ...
  const { setCurrent, setOpens, setAllItems, source } =
  ...
  return (
    <div className='add'>
      ...
      <div className='button save-button' title='Save' onClick={add}>
        <CheckIcon />
      </div>
    </div>
  )
...
function RenameMode({
  ...
  const { loadAllItems, config, source } = useContext(DesktopContext)
  ...
  return (
    <div className='rename'>
      ...
      <div className='button save-button' onClick={submit} title='Save'>
        <CheckIcon />
      </div>
    </div>
  )
...
export function FolderNode({
  ...
  return (
    <div className='node folder'>
      ...
      {mode === 'add' && <AddMode paths={paths} setMode={setMode} />}
      {mode === 'rename' && <RenameMode paths={paths} setMode={setMode} />}
      <div className='subs' style={{ display: collapsed ? 'none' : 'block' }}>
        {subs.map((sub, i) =>
          sub.type === 'folder' ? (
            <FolderNode
